...
while run:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:  # print("A keystroke is pressed")
            if event.key == pygame.K_LEFT:
                playerX_change = -2.5  # print("Left arrow is pressed")
            if event.key == pygame.K_RIGHT:
                playerX_change = 2.5  # print("Right arrow is pressed")
    ...
    display_text(textX, textY, "SCORE:" + str(score_value) + "  DIFFICULT", (255,255,255))
